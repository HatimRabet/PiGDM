...
if __name__ == "__main__":
    ...
    measurement_operator = BlurPseudoinverseOperator(kernel_size=21, sigma=1000.0)
    ...
    out = torch.cat((low_res_img, tensor_img, low_res_img_show), dim = 2)
